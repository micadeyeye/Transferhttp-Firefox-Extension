...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\httpsessionmobility on
     Windows, /home/user/dev/httpsessionmobility on Linux) in a file named
     httpsessionmobility@adeyeye.michael and copy that file to
